...
class scripts_control {
	...
	public function admin_enqueue_scripts( $hook ) {
		...
		if( 'cahnrs-category' === get_current_screen()->taxonomy )
			\wp_enqueue_style( 'cahnrs-categories-edit-style', URL . 'css/edit-tags-style.css', array() );

		if ( 'post.php' === $hook || 'post-new.php' === $hook ) {
			\wp_enqueue_style( 'cahnrs-categories-style',   URL . 'css/edit-post.css', array() );
			\wp_enqueue_script( 'cahnrs-categories-script', URL . 'js/edit-post.js',   array() );
		}
